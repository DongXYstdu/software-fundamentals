...
<a class='context-link prev' href='/software-fundamentals/posts/Redis-Redis数据类型/'><span class='context-label'>上一篇</span><span class='context-title'>Redis数据类型和应用场</span></a>
<a class='context-link next' href='/software-fundamentals/posts/Redis-Redis简介/'><span class='context-label'>下一篇</span><span class='context-title'>什么是Redis</span></a>
</div>
