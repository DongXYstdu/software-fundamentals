...
<a class='context-link prev' href='/software-fundamentals/posts/分布式系统-CAP与一致性/'><span class='context-label'>上一篇</span><span class='context-title'>分布式系统：CAP 与一致性——从理论到工程实践</span></a>
<a class='context-link next' href='/software-fundamentals/posts/分布式系统-消息队列/'><span class='context-label'>下一篇</span><span class='context-title'>分布式系统：消息队列——从解耦到可靠传递</span></a>
</div>
