...
<a class='context-link prev' href='/software-fundamentals/posts/数据库-常见面试题解析/'><span class='context-label'>上一篇</span><span class='context-title'>数据库：常见面试题解析</span></a>
<a class='context-link next' href='/software-fundamentals/posts/数据库系统-B+树与索引/'><span class='context-label'>下一篇</span><span class='context-title'>数据库系统：B+ 树与索引的原理</span></a>
</div>
