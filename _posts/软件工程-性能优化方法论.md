...
<a class='context-link prev' href='/software-fundamentals/posts/软件工程-代码重构/'><span class='context-label'>上一篇</span><span class='context-title'>代码重构——从异味识别到持续改进的工程实践</span></a>
<a class='context-link next' href='/software-fundamentals/posts/软件工程-软件测试方法论/'><span class='context-label'>下一篇</span><span class='context-title'>软件测试方法论——从单元测试到混沌工程的体系化实践</span></a>
</div>
