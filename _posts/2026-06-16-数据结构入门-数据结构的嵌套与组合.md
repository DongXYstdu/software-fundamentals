...
<a class='context-link prev' href='/software-fundamentals/posts/数据结构入门-什么是数据结构/'><span class='context-label'>上一篇</span><span class='context-title'>数据结构入门：什么是数据结构</span></a>
<a class='context-link next' href='/software-fundamentals/posts/软件基础学习路线与方法论/'><span class='context-label'>下一篇</span><span class='context-title'>软件基础学习路线与方法论</span></a>
</div>
