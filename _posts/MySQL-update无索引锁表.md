...
← [MySQL 是怎么加锁的？](https://xiaolincoding.com/mysql/lock/how_to_lock.html) [MySQL 记录锁+间隙锁可以防止删除操作而导致的幻读吗？](https://xiaolincoding.com/mysql/lock/lock_phantom.html) →

<div class='context-nav'>
<a class='context-link prev' href='/software-fundamentals/posts/MySQL-count区别/'><span class='context-label'>上一篇</span><span class='context-title'>count(*)和count(1)区别</span></a>
<a class='context-link next' href='/software-fundamentals/posts/MySQL-三大日志的作用/'><span class='context-label'>下一篇</span><span class='context-title'>undo log、redo log、binlog有什么用</span></a>
</div>
