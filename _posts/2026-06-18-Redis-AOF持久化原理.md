...
<a class='context-link prev' href='/software-fundamentals/posts/MySQL面试-自增主键用完了怎么办/'><span class='context-label'>上一篇</span><span class='context-title'>自增主键用完了怎么办？</span></a>
<a class='context-link next' href='/software-fundamentals/posts/Redis-RDB快照原理/'><span class='context-label'>下一篇</span><span class='context-title'>RDB快照是怎么实现的？</span></a>
</div>
