...
<a class='context-link prev' href='/software-fundamentals/posts/MySQL-Buffer Pool原理/'><span class='context-label'>上一篇</span><span class='context-title'>揭开Buffer_Pool的面</span></a>
<a class='context-link next' href='/software-fundamentals/posts/MySQL-MySQL架构/'><span class='context-label'>下一篇</span><span class='context-title'>MySQL的架构是怎样的？</span></a>
</div>
