...
<a class='context-link prev' href='/software-fundamentals/posts/数据库入门-理解数据库的基本概念/'><span class='context-label'>上一篇</span><span class='context-title'>数据库入门：理解数据库的基本概念</span></a>
<a class='context-link next' href='/software-fundamentals/posts/数据结构入门-C语言结构体与数据嵌套/'><span class='context-label'>下一篇</span><span class='context-title'>数据结构入门：C语言结构体与数据嵌套</span></a>
</div>
