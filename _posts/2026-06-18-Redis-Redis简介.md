...
什么是 Redis？
大家好，我是小林。
在网上看到一篇很不错的 Redis  文章，内容很精炼，而且图画的非常棒，所以分享给大家一起拜读拜读，主要说了「
Redis 介绍、Redis 架构、Redis 持久化
」这三个方面。
算是把Redis核心的功能都介绍了一下，可以从宏观的视角来了解 Redis，很适合作为重新复习 Redis 的文章。
当然，这篇文章也不是把所有 Redis 功能都介绍了，如果你想了解更多 Redis 其他知识，可以看我之前写的这篇：
3 万字 + 40 张图 | 攻破 Redis 常见面试题
(opens new window)
好了，话不多说了，发车！
#
什么是 Redis？
