...
<a class='context-link prev' href='/software-fundamentals/posts/软件工程-API设计原则/'><span class='context-label'>上一篇</span><span class='context-title'>API设计原则——构建一致、健壮、可演进的接口体系</span></a>
<a class='context-link next' href='/software-fundamentals/posts/软件工程-性能优化方法论/'><span class='context-label'>下一篇</span><span class='context-title'>性能优化方法论——从测量到调优的系统性工程实践</span></a>
</div>
