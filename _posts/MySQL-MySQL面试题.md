...
<a class='context-link prev' href='/software-fundamentals/posts/MySQL-MySQL锁类型/'><span class='context-label'>上一篇</span><span class='context-title'>MySQL有哪些锁</span></a>
<a class='context-link next' href='/software-fundamentals/posts/MySQL-SQL查询执行过程/'><span class='context-label'>下一篇</span><span class='context-title'>执行一条SQL查询语句期间发生了什么？</span></a>
</div>
