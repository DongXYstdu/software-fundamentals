...
3. **监控 MDL 锁等待** ：
   ...
   * 执行前检查是否有长事务
   * 使用 performance\_schema.metadata\_locks 监控
4. **设置超时时间** ：
...
1. **追问一：Online DDL 期间，如果写入量很大会有什么影响？**
