...
<a class='context-link prev' href='/software-fundamentals/posts/数据结构-二叉树与遍历/'><span class='context-label'>上一篇</span><span class='context-title'>二叉树与遍历</span></a>
<a class='context-link next' href='/software-fundamentals/posts/数据结构-哈希表从原理到实现/'><span class='context-label'>下一篇</span><span class='context-title'>数据结构：哈希表，从原理到实现</span></a>
</div>
