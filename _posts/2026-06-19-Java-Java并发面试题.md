...
<a class='context-link prev' href='/software-fundamentals/posts/Java-Java并发编程总结/'><span class='context-label'>上一篇</span><span class='context-title'>Java并发编程核心总结</span></a>
<a class='context-link next' href='/software-fundamentals/posts/Java-Java集合框架总结/'><span class='context-label'>下一篇</span><span class='context-title'>Java集合框架全面总结</span></a>
</div>
