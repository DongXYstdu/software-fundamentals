...
<a class='context-link prev' href='/software-fundamentals/posts/编程语言-垃圾回收与内存管理/'><span class='context-label'>上一篇</span><span class='context-title'>编程语言：垃圾回收与内存管理——从手动管理到所有权模型</span></a>
