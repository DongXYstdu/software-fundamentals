...
<a class='context-link prev' href='/software-fundamentals/posts/MySQL-可重复读与幻读/'><span class='context-label'>上一篇</span><span class='context-title'>MySQL可重复读隔离级别完全解决幻读了吗</span></a>
<a class='context-link next' href='/software-fundamentals/posts/MySQL-死锁原因分析/'><span class='context-label'>下一篇</span><span class='context-title'>加了什么锁导致死锁的？</span></a>
</div>
