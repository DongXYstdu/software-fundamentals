...
<a class='context-link prev' href='/software-fundamentals/posts/操作系统-线程崩溃进程也会崩溃吗/'><span class='context-label'>上一篇</span><span class='context-title'>线程崩溃了，进程也会崩溃吗？</span></a>
<a class='context-link next' href='/software-fundamentals/posts/操作系统-进程崩溃已写入数据会丢失吗/'><span class='context-label'>下一篇</span><span class='context-title'>进程写文件时，进程发生了崩溃，已写入的数据会丢失吗？</span></a>
</div>
