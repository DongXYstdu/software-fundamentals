...
| 场景 | 推荐引擎 | 原因 |
|---|---|---|
| 电商订单 | InnoDB | 需要事务保证数据一致性 |
| 高并发读写 | InnoDB | 行级锁 + MVCC |
| 日志分析（只读） | MyISAM | COUNT(*) 快，无写操作 |
| 全文搜索 | MyISAM/InnoDB | MySQL 5.6+ InnoDB 也支持全文索引 |
...
---
> 参考来源：[MySQL InnoDB 和 MyISAM 有什么区别？](https://www.quanxiaoha.com/java-interview/mysql-innodb-vs-myisam)
