...
<a class='context-link prev' href='/software-fundamentals/posts/数据结构-栈与队列深入解析/'><span class='context-label'>上一篇</span><span class='context-title'>数据结构：栈与队列深入解析</span></a>
<a class='context-link next' href='/software-fundamentals/posts/算法-动态规划从入门到精通/'><span class='context-label'>下一篇</span><span class='context-title'>动态规划从入门到精</span></a>
</div>
