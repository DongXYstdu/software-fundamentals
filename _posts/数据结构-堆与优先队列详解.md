...
<a class='context-link prev' href='/software-fundamentals/posts/数据结构-图与图算法全面解析/'><span class='context-label'>上一篇</span><span class='context-title'>数据结构：图与图算法全面解析</span></a>
<a class='context-link next' href='/software-fundamentals/posts/数据结构-常见面试题解析/'><span class='context-label'>下一篇</span><span class='context-title'>数据结构：常见面试题解析</span></a>
</div>
