...
<a class='context-link prev' href='/software-fundamentals/posts/Redis-AOF持久化原理/'><span class='context-label'>上一篇</span><span class='context-title'>AOF持久化是怎么实现的？</span></a>
<a class='context-link next' href='/software-fundamentals/posts/Redis-Redis主从复制/'><span class='context-label'>下一篇</span><span class='context-title'>主从复制是怎么实现的？</span></a>
</div>
