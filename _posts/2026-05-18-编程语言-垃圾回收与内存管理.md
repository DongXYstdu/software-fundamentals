...
<a class='context-link prev' href='/software-fundamentals/posts/编程语言-Python3基础教程/'><span class='context-label'>上一篇</span><span class='context-title'>Python3基础教程</span></a>
<a class='context-link next' href='/software-fundamentals/posts/编程语言-类型系统详解/'><span class='context-label'>下一篇</span><span class='context-title'>编程语言：类型系统详解——从静态类型到代数数据类型</span></a>
</div>
